...
namespace SIREngine::Core::Logger
{
	namespace ELogLevel
	{
		enum Type : uint32_t
	...
	{
	public:
		CLogCategory( const eastl::string& categoryName, ELogLevel::Type nDefaultVerbosity );
		~CLogCategory();
		...
		SIRENGINE_FORCEINLINE SIRENGINE_CONSTEXPR const eastl::string& GetCategoryName( void ) const
		{ return m_Name; }
	...
	public:
		...
		static bool g_bLogIncludeFileInfo;
		static bool g_bLogIncludeTimeInfo;
	private:
