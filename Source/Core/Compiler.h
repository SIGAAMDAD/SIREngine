#ifndef __SIRENGINE_COMPILER_H__
#define __SIRENGINE_COMPILER_H__
...
#include "Platform.h"
	...
	#define SIRENGINE_COMPILER_MSVC 1
...
// could mark the wrong one in your editor!
	...
	#define SIRENGINE_FUNC_NAME "SIRENGINE_FUNC_NAME unknown!"
		...
		#define SIRENGIEN_FORCEINLINE inline
			...
			#define SIRENGINE_CONSTEXPR constexpr
		#else
			#define SIRENGINE_CONSTEXPR const
		#endif
	#endif
#endif
...
#if !defined(SIRENGINE_ZeroMemory)
	#define SIREngine_ZeroMemory( obj ) memset( obj, 0, sizeof( obj ) )
	#define SIREngine_ZeroMember( obj ) memset( obj, 0, sizeof( *obj ) )
#endif

#ifdef ZeroMemory
#undef ZeroMemory
#define ZeroMemory( obj ) SIREngine_ZeroMemory( obj )
#endif
...
#define SIREngine_ArrayLength( arr ) ( sizeof( arr ) / sizeof( *arr ) )
