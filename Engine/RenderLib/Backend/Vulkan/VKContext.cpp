...
#if 1
	pBuffer = Mem_Realloc( pOriginal, nSize );
#else
...
#else
	pExtensionList = glfwGetRequiredInstanceExtensions( &nExtensionCount );
#endif
...
#else
	VK_CALL( glfwCreateWindowSurface( m_hInstance, m_pWindow, NULL, &m_hSurface ) );
#endif
