...
namespace lodepng {
#ifdef LODEPNG_COMPILE_DECODER
/*Same as lodepng_decode_memory, but decodes to an CVector. The colortype
...
#ifdef LODEPNG_COMPILE_ENCODER
/*Same as lodepng_encode_memory, but encodes to an CVector. colortype
...
#ifdef LODEPNG_COMPILE_CPP
/* The LodePNG C++ wrapper uses CVectors instead of manually allocated memory buffers. */
namespace lodepng {
#ifdef LODEPNG_COMPILE_PNG
...
#ifdef LODEPNG_COMPILE_DISK
/*
Load a file from disk into an CVector.
return value: error code (0 means ok)
...
unsigned decompress(CVector<unsigned char>& out, const unsigned char* in, size_t insize,
                    const LodePNGDecompressSettings& settings = lodepng_default_decompress_settings);

/* Zlib-decompress an CVector */
...
unsigned compress(CVector<unsigned char>& out, const unsigned char* in, size_t insize,
                  const LodePNGCompressSettings& settings = lodepng_default_compress_settings);

/* Zlib-compress an CVector */
...
The C++ version has extra functions with CVectors in the interface and the
...
CVectors and CFilePaths in C++ can be incompatible.
...
*) 04 jun 2007: improved support for Visual Studio 2005: crash with accessing
    invalid CVector element [0] fixed, and level 3 and 4 warnings removed
...
*) 07 sep 2005: (!) Changed to CVector interface
